...
self.addEventListener("push", event => {
  ...
  event.waitUntil(self.registration.showNotification(payload.title || "Nuvora", { body: payload.body || "You have a new update.", icon: "/favicon.svg", data: { url: payload.url || "/notifications" } }));
});
