...
export async function storagePresignPut(relKey: string): Promise<{ key: string; uploadUrl: string; url: string }> {
...
export async function storagePut(
  ...
  const { key, uploadUrl, url } = await storagePresignPut(relKey);
